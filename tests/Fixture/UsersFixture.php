...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'province' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'role_key' => ['type' => 'index', 'columns' => ['role'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id'], 'length' => []],
            'email' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
            'role_key' => ['type' => 'foreign', 'columns' => ['role'], 'references' => ['role', 'name'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-10-28 13:22:49',
            'modified' => '2015-10-28 13:22:49'
        ],
    ];
}
